...
# Test funtion- > should be modified in future to include public data (twin, mouse, mock)
# infant.wgs.pathway.drop=poison_regression_permute(infant.cog.drop,n.total,n.gr1,n.gr2,email)
