...
#eliminate mean and sd rows
#TABLE4= TABLE3[-c(2,3,5,6)]



#Test
#otu_abundance_compare(otu.normed, meta)




# Write data.frame to the File
#-----------------------------
#write.table(TABLE4, file=paste("OTU_Species_Compare_Norm_All_",today,".csv",sep=""), sep=",", row.names=F)
